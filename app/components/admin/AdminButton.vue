...
<style scoped>
.admin-button {
  @apply inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl px-4 py-2.5 text-sm font-semibold shadow-sm transition-all active:scale-[0.98];
}
